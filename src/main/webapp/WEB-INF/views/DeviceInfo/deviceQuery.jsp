...
<!-- 相关js路径  -->
<script
	src="<%=request.getContextPath()%>/resources/pages/scripts/DeviceInfo/deviceQuery.js"></script>
		...
		<div id="divQuery">
			<div
				...
				<table style="vertical-align: middle;border-spacing: 1em;">
					<tr>
						<td style="text-align: right;"><span>设备SN:</span></td>
						<td><input type="text" id="deviceSN" class="deviceSN"
							name="deviceSN" required></input></td>
					</tr>
				</table>
			</div>

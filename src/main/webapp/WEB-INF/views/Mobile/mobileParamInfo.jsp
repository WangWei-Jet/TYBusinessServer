...
<script
	src="<%=request.getContextPath()%>/resources/pages/scripts/Mobile/mobileParamInfo.js"></script>
...
<body class="commonPageBody">
	...
	<div id="nav">
		<p id="mobileParamQuery">手机参数查询</p>
	</div>
	...
	<div id="section">
		<div class="discription">
			...
			<ul style="margin-top: 10px;">
				<li><strong style="font-size: medium;">手机参数查询</strong></li>
			</ul>
		</div>
	</div>
</body>

...
public class AlgorithmUtil {
	 ...
	 *            证书类型
	 */
	public static void initUtil(String cert_path, String cert_pwd, String key_store_type) {
		try {
			CERT_PWD = cert_pwd;
			keyStore = initKeyStore(cert_path, cert_pwd, key_store_type);
		} catch (Exception e) {
			System.out.println("fail to init keystore...");
		}
	}
	...
	public static PrivateKey getPrivateKey() throws Exception {
		return (PrivateKey) keyStore.getKey(getAlias(), CERT_PWD.toCharArray());
	}
	 ...
	 * @return
	 */
	public static KeyStore initKeyStore(String cert_path, String cert_pwd, String key_store_type) throws Exception {
		...
		ks.load(is, cert_pwd.toCharArray());
		is.close();
		return ks;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("\n\n私钥解密:" + new String(decrypt(Base64.decode(sourceData.getBytes()), false), "GBK"));
